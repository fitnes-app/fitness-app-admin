...
/**
 * Jersey REST client generated for REST resource:DailyTipFacadeREST
 * [dailytip]<br>
 * USAGE:
 * <pre>
 *        DailyTipClient client = new DailyTipClient();
 ...
 * @author Naluem
 */
public class DailyTipClient {

	private WebTarget webTarget;
	private Client client;
	private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

	public DailyTipClient() {
		client = javax.ws.rs.client.ClientBuilder.newClient();
		webTarget = client.target(BASE_URI).path("dailytip");
	}

	public DailyTipClient(String username, String password) {
		this();
