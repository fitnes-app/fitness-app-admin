 ...
 * @author Jordi
 */
public class SpecialityClient {
    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

    public SpecialityClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("speciality");
    }

    public SpecialityClient(String username, String password) {
        this();
