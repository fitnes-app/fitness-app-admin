...
/**
 * Jersey REST client generated for REST resource:SpecificTipFacadeREST
 * [specifictip]<br>
 * USAGE:
 * <pre>
 *        SpecificTipClient client = new SpecificTipClient();
 ...
 * @author Naluem
 */
public class SpecificTipClient {

	private WebTarget webTarget;
	private Client client;
	private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

	public SpecificTipClient() {
		client = javax.ws.rs.client.ClientBuilder.newClient();
		webTarget = client.target(BASE_URI).path("specifictip");
	}

	public SpecificTipClient(String username, String password) {
		this();
