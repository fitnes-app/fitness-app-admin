...
/**
 * Jersey REST client generated for REST resource:MuscularGroupFacadeREST
 * [musculargroup]<br>
 * USAGE:
 * <pre>
 ...
 * @author Naluem
 */
public class MuscularGroupClient {

	private WebTarget webTarget;
	private Client client;
	private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

	public MuscularGroupClient() {
		client = javax.ws.rs.client.ClientBuilder.newClient();
		webTarget = client.target(BASE_URI).path("musculargroup");
	}

	public MuscularGroupClient(String username, String password) {
		this();
