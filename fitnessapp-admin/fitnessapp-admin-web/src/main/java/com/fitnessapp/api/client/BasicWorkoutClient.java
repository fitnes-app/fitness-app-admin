...
/**
 * Jersey REST client generated for REST resource:BasicWorkoutFacadeREST
 * [basicworkout]<br>
 * USAGE:
 * <pre>
 ...
 * @author Naluem
 */
public class BasicWorkoutClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

    public BasicWorkoutClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("basicworkout");
    }

    public BasicWorkoutClient(String username, String password) {
        this();
