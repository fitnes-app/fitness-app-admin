...
/**
 * Jersey REST client generated for REST resource:AdvancedWorkoutFacadeREST
 * [advancedworkout]<br>
 * USAGE:
 * <pre>
 ...
 * @author Naluem
 */
public class AdvancedWorkoutClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

    public AdvancedWorkoutClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("advancedworkout");
    }

    public AdvancedWorkoutClient(String username, String password) {
        this();
