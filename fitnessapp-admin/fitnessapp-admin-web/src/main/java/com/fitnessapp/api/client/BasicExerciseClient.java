...
/**
 * Jersey REST client generated for REST resource:BasicExerciseFacadeREST
 * [basicexercise]<br>
 * USAGE:
 * <pre>
 *        BasicExerciseClient client = new BasicExerciseClient();
 ...
 * @author Naluem
 */
public class BasicExerciseClient {

    private WebTarget webTarget;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

    public BasicExerciseClient() {
        client = javax.ws.rs.client.ClientBuilder.newClient();
        webTarget = client.target(BASE_URI).path("basicexercise");
    }

    public BasicExerciseClient(String username, String password) {
        this();
