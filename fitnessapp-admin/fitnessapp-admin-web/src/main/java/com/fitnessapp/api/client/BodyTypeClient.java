...
/**
 * Jersey REST client generated for REST resource:BodyTypeFacadeREST
 * [bodytype]<br>
 * USAGE:
 * <pre>
 ...
 * @author Naluem
 */
public class BodyTypeClient {

	private WebTarget webTarget;
	private Client client;
	private static final String BASE_URI = "http://localhost:8080/fitness-app-api-web/api";

	public BodyTypeClient() {
		client = javax.ws.rs.client.ClientBuilder.newClient();
		webTarget = client.target(BASE_URI).path("bodytype");
	}

	public BodyTypeClient(String username, String password) {
		this();
